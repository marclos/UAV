...
\item Your computer should continue its ability to connect to the microprocessor remotely even after you've shut it off.  If it won't let you, try: checking that your SSH is still enabled; re-download the xrdp package; restart the app that allows you to connect to the microprocessor.
