...
class Sensor():
  ...
  def read(self):
    ...
    if data[0] != '42' or data[1] != '4D' # Maybe lowercase d? No, the  code won't run with a lowercase d (AB)
      return None
    ...
    return res # Indentation issues? Make sure the return res line is inside of the def read(self) line (this was AB's issue the first time around, but it should run with res located here) (AB)
