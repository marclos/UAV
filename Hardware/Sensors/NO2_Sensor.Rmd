...
While we are working in the Raspberry Pi shell, we can configure the Pi's settings to allow us to receive SPI signlas, which is what the MiCS-2714 produces.  To do so, enter
```{python, eval=FALSE, python.reticulate=FALSE}
sudo raspi-config
```
